  ...
  askGithubOrg: () => {
    const questions = [
      ...
      },
      {
        name: 'source',
        type: 'input',
        message: 'Enter the team whose repository permissions you would like to copy from:',
        validate: function( value ) {
          if (value.length) {
            return true;
          } else {
      ...
      },
      {
        name: 'destination',
        type: 'input',
        message: 'Enter the team whose repository permissions you would like to copy to:',
        validate: function(value) {
          if (value.length) {
            return true;
          } else {
