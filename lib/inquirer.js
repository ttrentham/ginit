  ...
  askGithubOrg: () => {
    const questions = [
      ...
      },
      {
        name: 'useteams',
        type: 'confirm',
        message: 'Do you want to copy permissions between teams?'
      },
      {
        name: 'source',
        type: 'input',
        message: 'Enter the team whose repo permissions you would like to copy from:',
        validate: function( value ) {
          if (value.length) {
            return true;
          } else {
      ...
      },
      {
        name: 'destination',
        type: 'input',
        message: 'Enter the team whose repo permissions you would like to copy to:',
        validate: function(value) {
          if (value.length) {
            return true;
          } else {
