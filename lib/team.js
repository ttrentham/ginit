...
/*
 Translates repo permissions returned into what's expected when
 they are set
*/
export function convertPermissions(permissions) {
...
export const copyTeamPermissions = async (org, source, destination) => {
  ...
  try {
    ...
    console.log("The source team %s's id is %d", sourceTeam.data.name, team_id);
